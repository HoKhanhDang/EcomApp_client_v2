...
export default function ShowProductsSearch() {
    ...
    const fetchData2 = async ({length2}) => {
        if (length2 == 0) {
            setIsNone(true);
            setTotalPages(Math.ceil(parseFloat(length2 / limitPage)) || 1);
            return;
        } else {
            setTotalPages(Math.ceil(parseFloat(length2 / limitPage)));
            const paging = await apiGetProduct({
                page: currentPage,
                limit: limitPage,
                category: params.get("key"),
    ...
    const fetchData = async () => {
        ...
        const length2 = rs2.data.res.length;
    ...
    return (
        <div className="w-full h-auto ">
            ...
            <div className="w-full h-auto md:h-[100px] my-[20px] border flex flex-col md:flex-row">
            ...
            <div className="w-full h-[100px] flex justify-center items-center mt-[50px]">
                <PaginatedPage
