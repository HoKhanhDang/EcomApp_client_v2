        ...
        <div className="flex flex-col justify-center w-full h-full">
            <div className="h-[20%] flex flex-row justify-center items-center  w-full pt-5">
                <p
                    ...
                    class="px-[25px] font-bold text-[25px] font-main text-main-100"
                >
                    Deal of the day!
                </p>
            </div>
            ...
            <div className="h-[20%] flex flex-row justify-center items-center">
                {product?.quantity > 0 ? (
                    <div
                        ...
                        className="m-5 flex h-[40%] w-[45%] justify-center items-center bg-main-100 hover:bg-slate-500"
                    >
                        <p className="text-[15px] font-light text-white flex flex-row justify-around items-center">
                            <CiShoppingCart className="text-[25px]" /> Add to
                            Cart
                        </p>
                    </div>
                ) : (
                    <div className="m-5 flex h-[40%] w-[45%] justify-center items-center bg-main-100 hover:bg-slate-500">
                        <p className="text-[15px] font-light text-white flex flex-row justify-around items-center">
                            SOLD OUT!
                        </p>
                    </div>
                ...
                >
                    <p className="text-[15px] font-light text-white flex flex-row justify-around items-center">
                        {" "}
                        <GiHamburgerMenu className="text-[20px] mr-2" /> Info
                    </p>
                </Link>
            </div>
        </div>
