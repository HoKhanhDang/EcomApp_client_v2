...
const banners = [
    {
        id: 1,
        image: "https://cdn2.fptshop.com.vn/unsafe/1920x900/filters:quality(100)/CT_1_1240x697_43d1fd795b.png",
        link: "/",
    },
    {
        id: 2,
        image: "https://cdn2.fptshop.com.vn/unsafe/1920x0/filters:quality(100)/CT_1_1240x697_d8c0eb7006.png",
        link: "/",
    },
];
var settings = {
                ...
                <div className=" md:h-[20%] w-full hidden md:flex  flex-row justify-start items-center pt-5 gap-[10px]">
                    <div className="w-[50%] h-full rounded-md">
                        <img
                            src={banners[0].image}
                            alt=""
                            className="w-full h-full object-fill shadow-xl rounded-md"
                        />
                    </div>
                    <div className="w-[50%] h-full rounded-md">
                        <img
